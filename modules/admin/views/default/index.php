    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [                      // the owner name of the model
                ...
                return User::findOne(['id'=>$model->user_id])->name;}
            ],
            [                      // the owner name of the model
            ...
            [                      // the owner name of the model
                ...
                (Html::a('Просмотр', ['view', 'id' => $model->id], ['class' => 'btn btn-primary'])).
                 ...
                 ($model->status_id==1 ? Html::a('Принята в работу', ['update-comment', 'id' => $model->id], ['class' => 'btn btn-primary']).
                Html::a('Выполнена', ['update-image', 'id' => $model->id], ['class' => 'btn btn-primary']):'');
